        ...
        {samples.map((sample) => {
          ...
          return (
            <button
              ...
              className={`rounded-lg px-3 py-2 text-xs font-semibold uppercase tracking-[0.08em] transition-colors ${
                active
                  ? "bg-white text-[#0a0c10]"
                  : "border border-white/10 bg-transparent text-white/65 hover:text-white"
              }`}
            >
              {sample.label}
            </button>
