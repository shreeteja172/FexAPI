...
import type { MockitField, MockitRoute } from "./schema";
...
const createValueFromField = (field: MockitField): unknown => {
  switch (field.type) {
    case "number":
...
const createRecordFromRoute = (route: MockitRoute): Record<string, unknown> => {
