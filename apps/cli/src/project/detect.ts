...
export const getSchemaTemplate = (
  ...
  return [
    ...
    "#",
    "# Complex types:",
    "#   [  → start an array of objects (close with ])",
    "#   {  → start a nested object (close with })",
    "#",
    "# Features:",
    "#   • Append ?count=<number> to GET requests to override",
    "#     the number of items generated (e.g., /users?count=100).",
    "#     Max count is 1000.",
    "# ──────────────────────────────────────────────",
    "",
    "# ──────────────────────────────────────────────",
